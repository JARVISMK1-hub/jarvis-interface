// JARVIS Voice System - Movie-Accurate Voice
...
class JarvisVoice {
    ...
    init() {
        // Speech Recognition - FASTER RESPONSE
        if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
            const SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition;
            this.recognition = new SpeechRecognition();
            this.recognition.continuous = false;
            this.recognition.interimResults = false;  // Changed to false for faster final results
            this.recognition.lang = 'en-US';
            this.recognition.maxAlternatives = 1;  // Only get best result for speed
            ...
            console.log('✅ Speech recognition ready - FAST MODE');
        }
    ...
    speak(text) {
        return new Promise((resolve) => {
            ...
            // ===== MOVIE-ACCURATE JARVIS VOICE SETTINGS =====
            // Paul Bettany's JARVIS: smooth, refined, not too deep, measured pace
            utterance.rate = 1.05;       // Slightly slower than 1.15 - more measured like movie
            utterance.pitch = 1.0;       // Normal pitch (not deep) - closer to movie JARVIS
